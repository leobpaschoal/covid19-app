...
class Graphic extends Component {
  ...
  getCasesByParticularCountry = async (country) => {
    console.log(this.props.dayOccurrences.country_name);
    await monitor()
  ...
  render() {
    ...
    return (
      <Card>
        <Card.Header>Graphics</Card.Header>
        <Card.Body>
          <div>
            <label>Country</label>
            ...
            >
              ...
              <Tooltip />
              <Legend />
              <Line type='monotone' dataKey='Confirmed' stroke='#3b79b7' activeDot={{ r: 8 }} />
              <Line type='monotone' dataKey='Deaths' stroke='#ad2836' />
              <Line type='monotone' dataKey='Recovered' stroke='#228b22' />
              <Line type='monotone' dataKey='Infected' stroke='#696969' />
            </LineChart>
          </div>
        </Card.Body>
      </Card>
